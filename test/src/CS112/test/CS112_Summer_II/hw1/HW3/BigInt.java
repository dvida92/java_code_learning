...
public class BigInt {
    ...
    public static Node reverseHelper(Node p, Node q) { // p is a stack that we pop from, and q a stack
        // we push onto
        if (p == null)
    ...
    public static void main(String[] args) {
        BigInt B = new BigInt("232342334");
        System.out.println(B);
        BigInt C = new BigInt("44303423");
        ...
        System.out.println("Should print out \n456039974045901016372286");
        System.out.println(C.mult(C.mult(B)));
